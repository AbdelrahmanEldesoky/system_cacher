        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 50px"> عدد بطاقات المادة :  {{ $products->total() }} </h3>
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (auth()->user()->hasPermission('products-update'))
                                            <a href="{{ route('dashboard.productindex', $product->id) }}" class="btn btn-info btn-facebook"><i class="fa fa-edit"></i> خصائص المادة</a>
                                        @else
                                            <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-android"></i>خصائص المادة</a>
                                        @endif
